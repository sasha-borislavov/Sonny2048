...
OUTLINE_COLOUR = (231, 192, 204)
OUTLINE_THICKNESS = 10
BACKGROUND_COLOUR = (242, 207, 218)
FONT_COLOUR = (199, 110, 101)

FONT = pygame.font.SysFont("comicsans", 60, bold=True)
MOVE_VEL = 20

WINDOW = pygame.display.set_mode((WIDTH, HEIGHT))
pygame.display.set_caption("Sonny2048")
...
def move_tiles(windows, tiles, clock, direction):
    updated = True
    blocks = set()
    ...
    while updated:
        ...
        update_tiles(windows, tiles, sorted_tiles)
